  ...
  return (
    <StyledWrapper>
      <div className="card mb-4">
        <div className="profile-pic mb-4 relative w-32 h-32 overflow-hidden">
          {isClient && (
            <Image
              src={imageUrl}
              alt="profile"
        ...
        <div className="bottom">
          {/* Changed mb-16 to mb-12 to reduce the gap */}
          <div className="mb-25 flex flex-col justify-center items-center content">
            <h1 className="name w-full text-2xl mb-0">{name}</h1>
            <span className="text-white font-bold w-full text-lg mb-4">{role}</span>
            <span className="w-full italic text-white">{quote}</span>
          </div>
          <div className="bottom-bottom">
            <div className="flex gap-6 justify-center social-links-container">
              <a href={instagram} target="_blank" rel="noopener noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 30 30"
                  className="svg instagram-icon"
                >
...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    padding: 4px;
    position: relative;
    box-shadow: #604b4a30 0px 80px 35px -60px;
  ...
  .card .bottom {
    ...
    /* Modified top position to reduce the gap */
    top: 20%;
  ...
  .card .bottom .bottom-bottom .social-links-container .instagram-icon:hover {
    fill: #e1306c; /* Instagram pink/purple */
    transform: scale(1.2);
  }

  .card .bottom .bottom-bottom .social-links-container .github-icon:hover {
    fill: #6e5494; /* GitHub purple */
    transform: scale(1.2);
  }

  .card .bottom .bottom-bottom .social-links-container .linkedin-icon:hover {
