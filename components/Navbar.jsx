...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-primary dark:bg-primary text-white py-3 px-4 md:px-6 shadow-lg sticky top-0 z-50 border-b border-[#8617c0]/30 dark:border-[#340181]/30">
